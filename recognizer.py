...
class PAJ7620U2(object):
    ...
    def check_gesture(self):
        ...
        if Gesture_Data == PAJ_UP:
            print("Down\r\n")
            r = requests.get(url = "http://" + direccionIP + ":" + puerto + "/down")
        elif Gesture_Data == PAJ_DOWN:
            print("Up\r\n")
            r = requests.get(url = "http://" + direccionIP + ":" + puerto + "/up")
        #elif Gesture_Data == PAJ_LEFT:
        #    print("Left\r\n")   
        #    r = requests.get(url = "http://" + direccionIP + ":" + puerto + "/left")
        #elif Gesture_Data == PAJ_RIGHT:
        #    print("Right\r\n")  
        #    r = requests.get(url = "http://" + direccionIP + ":" + puerto + "/right")
        return Gesture_Data

#IR_SENSOR_1 = 27

def s1_handler(channel):
        r = requests.get(url = "http://" + direccionIP + ":" + puerto + "/Mute")
        print("Mute")
...
if __name__ == '__main__':
    ...
    #GPIO.add_event_detect(IR_SENSOR_1, GPIO.FALLING, 
